...
<a
	...
	><div class="w-full">
		...
		<p
			class="break-all text-gray-600 hover:text-yellow-600 dark:text-gray-400 dark:hover:text-yellow-100 sm:break-words"
		>
			<slot />
		</p>
		<div
		...
		>
			...
			<div class="rounded-md bg-gray-200 px-4 capitalize dark:bg-gray-700 dark:text-gray-400">
				{item?.category || 'note'}
			</div>
